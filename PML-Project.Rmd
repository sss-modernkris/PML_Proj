...
Training accuracy in the training set I constructed is  ~100% (see the results in Final Model section). Accuracy on the cross validation set I constructed was 99.5% (see the results in Cross Validation section). Finally, pridicted the classe for the test data using the final random forest model.
